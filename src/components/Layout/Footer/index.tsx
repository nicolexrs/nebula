      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 relative z-10 pb-16">
        <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4">
            ...
            <h4 className="text-white/60 text-sm font-normal mb-6 flex gap-2">
              <Image src={'/images/footer/email.svg'} alt="email-icon" width={20} height={20} />admin@nebulaxbt.com
            </h4>
            <h4 className="text-white/60 text-sm font-normal mb-6 flex gap-2">
              <Image src={'/images/footer/address.svg'} alt="address-icon" width={20} height={20} /> 1234 North Avenue Luke Lane, South Bend, IN 360001
            </h4>
          </div>
        </div>
      </div>
      <div className='py-2 px-4 border-t border-t-lightblue'>
        <h3 className='text-center text-white'>@2025 - All Rights Reserved </h3>
      </div>
    </footer>
  )
}
