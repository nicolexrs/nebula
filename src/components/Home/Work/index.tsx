        ...
        <section>
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 relative'>
                ...
                <div className='text-center mb-14'>
                    <h3 className='text-white/80 text-3xl md:text-5xl font-bold mb-3'>How It Works</h3>
                    <p className='text-white/60 md:text-lg font-normal leading-8'>
                        Trade crypto seamlessly with NebulaXBT. Our platform offers lightning-fast execution, advanced trading tools, and secure transactions. <br />
                        Get started in minutes and elevate your trading experience.
                    </p>
                </div>
